...
export default class NBAAIScannerModule extends BaseAIScanner {
  alertType = 'NBA_AI_SCANNER';
  sport = 'NBA';

  private readonly STAR_PLAYERS = [
    'Jokic', 'Antetokounmpo', 'Doncic', 'Embiid', 'Curry', 
    'Durant', 'James', 'Tatum', 'Gilgeous-Alexander', 'Edwards'
  ];
