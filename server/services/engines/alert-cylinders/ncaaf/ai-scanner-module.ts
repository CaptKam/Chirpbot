...
export default class NCAAFAIScannerModule extends BaseAIScanner {
  alertType = 'NCAAF_AI_SCANNER';
  sport = 'NCAAF';

  private readonly STAR_QBS = [
    'Williams', 'Maye', 'Daniels', 'Penix', 'Ward', 'Beck',
    'Ewers', 'Milroe', 'Gabriel', 'Nussmeier'
  ];
