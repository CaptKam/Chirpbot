...
const NEW_ALERT_TYPES = {
  NCAAF: [
    'NCAAF_CLOSE_GAME', 'NCAAF_FOURTH_QUARTER', 'NCAAF_HALFTIME', 'NCAAF_GAME_START',
    'NCAAF_SECOND_HALF_KICKOFF', 'NCAAF_TWO_MINUTE_WARNING', 'NCAAF_COMEBACK_POTENTIAL', 
    'NCAAF_FOURTH_DOWN_DECISION', 'NCAAF_MASSIVE_WEATHER', 'NCAAF_RED_ZONE_EFFICIENCY',
    'NCAAF_RED_ZONE', 'NCAAF_SCORING_PLAY', 'NCAAF_UPSET_OPPORTUNITY'
  ],
  MLB: [
