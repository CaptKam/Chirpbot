...
const teamColors: Record<string, Record<string, string>> = {
  'NFL': {
    ...
    'LAC': '#0080C6', 'CHA': '#0080C6', 'LAR': '#003594', 'LA': '#003594', 'LV': '#000000', 'MIA': '#008E97',
    'MIN': '#4F2683', 'NE': '#002244', 'NEW': '#002244', 'NO': '#D3BC8D', 'NYG': '#0B2265',
    'NYJ': '#125740', 'JET': '#125740', 'PHI': '#004C54', 'PIT': '#FFB612', 'SEA': '#002244',
    'SF': '#AA0000', 'TB': '#D50A0A', 'BUC': '#D50A0A', 'TEN': '#0C2340', 'WAS': '#5A1414', 'WSH': '#5A1414', 'COM': '#5A1414'
  },
  'MLB': {
