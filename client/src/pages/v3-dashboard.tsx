...
export default function V3Dashboard() {
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-solidBackground text-white antialiased">
        <PageHeader 
  ...
  return (
    <div className="min-h-screen bg-solidBackground text-white antialiased" data-testid="v3-dashboard">
      <PageHeader 
        title="V3 Performance Dashboard" 
        subtitle="Real-time monitoring of multi-sport intelligence platform performance"
        icon={BarChart3}
