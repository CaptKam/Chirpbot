...
/**
 * Get complete alert card colors (active and inactive states)
 */
export function getAlertCardColors(sport: string): { 
  borderActive: string; 
  bgActive: string; 
  ...
  switch (sportUpper) {
    case 'MLB':
      return {
        ...
        borderInactive: 'border-green-500/50',
        bgInactive: 'bg-green-500/5',
        text: 'text-green-400'
      };
    case 'NFL':
      return {
        ...
        borderInactive: 'border-orange-500/50',
        bgInactive: 'bg-orange-500/5',
    ...
    case 'NBA':
      return {
        ...
        borderInactive: 'border-purple-500/50',
    ...
    case 'NHL':
      return {
        ...
        borderInactive: 'border-cyan-500/50',
    ...
    case 'NCAAF':
      return {
        ...
        borderInactive: 'border-blue-500/50',
    ...
    case 'WNBA':
      return {
        ...
        borderInactive: 'border-pink-500/50',
        bgInactive: 'bg-pink-500/5',
        text: 'text-pink-400'
      };
    case 'CFL':
      return {
        ...
        borderInactive: 'border-red-500/50',
    ...
    default:
      return {
        ...
        borderInactive: 'border-emerald-500/50',
